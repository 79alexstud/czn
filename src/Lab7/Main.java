...
public class Main {
    public static void main(String[] args) {
        ...
        Reader1 usrdef = new Reader1("Petrov Petr Petrovich","Petrov", "1234567");
        read.takebook();
        adm.givebook();
        adm.findbook();
        adm.remind();
        libri1.orderbook();
        prov.getbook();
        usrdef.takebook(); // реализация интерфейса читателя для роли читателя
        usrdef.findbook(); // реализация интерфейса администратора для роли читателя
    }
}
